...
#define Button_5_EXTI_IRQn EXTI1_IRQn
...
#define Button_Spare_Pin GPIO_PIN_12
#define Button_Spare_GPIO_Port GPIOB
#define Button_Spare_EXTI_IRQn EXTI15_10_IRQn
